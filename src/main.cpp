...
#if defined(NDEBUG)
# error "KekCoin cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "KekCoin Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
    ...
    if(pindexBest->nHeight+1 >= 1 && pindexBest->nHeight+1 <= 100)
        {
...
int64_t GetProofOfStakeReward(const CBlockIndex* pindexPrev, int64_t nCoinAge, int64_t nFees)
{
    ...
    if(pindexPrev->nHeight+1 >= 1 && pindexPrev->nHeight+1 <= 100)
        {
            nSubsidy = 0 * COIN;
        }

    else if(pindexPrev->nHeight+1 >= 101 && pindexPrev->nHeight+1 <= 9999)
        {
            nSubsidy = 50 * COIN;
        }
    
    else if(pindexPrev->nHeight+1 >= 10000 && pindexPrev->nHeight+1 <= 19999)
        {
            nSubsidy = 25 * COIN;
        }

    else if(pindexPrev->nHeight+1 >= 20000 && pindexPrev->nHeight+1 <= 29999)
        {
            nSubsidy = 10 * COIN;
        }

    else if(pindexPrev->nHeight+1 >= 30000 && pindexPrev->nHeight+1 <= 99999)
        {
            nSubsidy = 5 * COIN;
        }

    else if(pindexPrev->nHeight+1 >= 100000 && pindexPrev->nHeight+1 <= 199999)
        {
            nSubsidy = 2.5 * COIN;
        }

    else if(pindexPrev->nHeight+1 >= 200000 && pindexPrev->nHeight+1 <= 9770000)
        {
            nSubsidy = 1 * COIN;
        }
...
static const int64_t nTargetTimespan = 22 * 60;  // 22 mins
