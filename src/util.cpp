...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\KekCoin
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\KekCoin
    // Mac: ~/Library/Application Support/KekCoin
    // Unix: ~/.kekcoin
#ifdef WIN32
    // Windows
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "kekcoin.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "kekcoind.pid"));
